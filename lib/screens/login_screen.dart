...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await context.read<AuthProvider>().signIn(_emailCtrl.text.trim(), _pwdCtrl.text);
    } catch (e) {
                ...
                children: [
                  ...
                  Center(
                    child: Column(
                      children: [
                        ...
                        Text(t('login.title', lang), style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 6),
                        Text(t('login.subtitle', lang), style: const TextStyle(color: AppColors.textSecondary, fontSize: 14), textAlign: TextAlign.center),
                      ],
                    ),
                  ),
                  ...
                  Align(
                    ...
                    child: TextButton(
                      ...
                      child: Text(t('login.forgotPwd', lang)),
                    ),
                  ),
                  const SizedBox(height: 16),
                  ...
                  Row(
                    ...
                    children: [
                      const Text('New to SarkariSewa? ', style: TextStyle(color: AppColors.textSecondary)),
                      TextButton(
                        onPressed: () => context.go('/signup'),
                        child: Text(t('login.createAcc', lang), style: const TextStyle(fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                  const SizedBox(height: 8),
